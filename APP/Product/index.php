<html>
  ...
  <div class="container-fluid">
    ...
    <nav class="navbar navbar-dark px-5 py-3 navbar-expand-md w-100  shadow">
        <div class="container-fluid">
            <a class="navbar-brand btn2 bi bi-pc-display" href="#"> NextPC</a>
  ...
  <section class="min-vh-100 p-5 d-flex flex-column flex-md-row text-white">
    ...
    <div class="likeBtn  ">
            ...
            <span class="bi bi-heart-fill" style="color:plum"> 100 Likes</span>
        </div>
      <img src="../../UPLOAD/PC/1.png" class="" />
    </div>
      <div class="btns">
        <!-- <button>
    ...
    <div class="flex-fill text-start w-100 px-5 py-3 d-flex flex-column ">
      <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <h4 class="price fs-5"> <span class="oldPrice">9999 Dhs</span> 7999 Dhs</h4>
      </div>
